...
class Caja():
	...
	def AgregarTextView(self):
		self.ScrollText.set_hexpand(True)
		self.ScrollText.set_vexpand(True)
		self.ScrollText.set_size_request(-1, 250)
		
		self.Text.show()
		self.Buffer = Gtk.TextBuffer();
		self.Text.set_buffer(self.Buffer);
		self.ScrollText.add( self.Text )
		self.Box.pack_start(self.ScrollText, True, True, 1)
	...
	def SetTextViewText(self, texto):
