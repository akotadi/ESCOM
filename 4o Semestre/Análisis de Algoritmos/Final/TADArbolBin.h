...
/*recibe<-árbol(A), árbol(B);
IsLeaf(A,P)
Efecto: Recibe dos arboles binarios A y B, los une añadiendo la frecuencia de ambos como valor.
Requerimientos: Ambos árboles binarios deben de no ser vacíos.
*/