...
<html lang="es">
	...
	<body>
		...
		<div class="w3-container">
			<hr>
			<div class="w3-center">
				<h2 w3-class="w3-jumbo">Clubes Pendientes</h2>
			</div>
				...
				<table class="w3-table w3-striped w3-bordered">
					...
					<tbody>
						<tr>
							<td>27</td>
							<td>Química</td>
							<td>Desarrollo de dinámicas para fomentar el aprendizaje de química en los alumnos</td>
							<td>Claudia Díaz González</td>
							<td><a href='verclub.php?idestudiante=0' class='w3-button w3-grey'>Ver</a></td></tr>
						</tr>
