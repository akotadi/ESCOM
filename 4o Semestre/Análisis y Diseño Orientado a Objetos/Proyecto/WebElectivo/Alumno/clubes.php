...
<html lang="es">
	...
	<body>
		...
		<?php
			...
			$conectar = conectar();
			if ($conectar) {
				$consulta = "select c.nombre as nombre,c.descripcion as descripcion,r.cupo as cupo,u.nombre as coordinador,et.cantidad as cantidad from club c,ejetematico et, registrado r, coordinador_has_club chc, coordinador co, usuario u where u.idUsuario = co.idUsuario
				    and co.idUsuario = chc.idUsuario
				    and chc.idClub = c.idClub
				    and c.idClub = r.idClub
				    and c.idEje = r.idEje
				    and c.idEje = et.idEje;";
									...
									while($Ren = mysqli_fetch_array($Registro))
									{
										...
										echo "<td>" . $Ren['cupo'] . "</td>";
										echo "<td>" . $Ren['coordinador'] . "</td>";
										echo "<td>" . $Ren['cantidad'] . "</td>";
										echo "</tr>";
									} 
