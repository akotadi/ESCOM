	...
	public static void main(String[] args) {
		...
		PcapPacketHandler<String> jpacketHandler = new PcapPacketHandler<String>() {
			...
			public void nextPacket(PcapPacket packet, String user) {
                ...
                System.out.printf("Longitud de la trama = %d (%04X)\n",longitud,longitud);

                if ((((trama[12] << 8) & 0xFF00) | ((trama[13]) & 0xFF))>0x05DC) {
                	System.out.println("Trama IEEE 802.3");
                	byte bDSAP = trama[14];
                	System.out.printf("DSAP = %02X\n",bDSAP);
                	if ((bDSAP & 0x01) == 0x00) {
                		System.out.println("Individual");
                	}
                	else{
                		System.out.println("Grupal")
                	}
                	byte bSSAP = trama[15];
                	System.out.printf("SSAP = %02X\n",bSSAP);
                	if ((bSSAP & 0x01) == 0x00) {
