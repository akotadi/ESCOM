...
public class metodos {
   ...
   try{
    ...
    public void BoEmpleado(String Code){
        String SQL = "DELETE FROM " + "mostrador " + "WHERE CURP = " + Code;
        try{
            PreparedStatement pstm1 = con.getConnection().prepareStatement(SQL);
            pstm1.execute();
            JOptionPane.showMessageDialog(null,"Se borro el registro con exito...");
        ...
        SQL = "DELETE FROM " + "empleado " + "WHERE CURP = " + Code;
        try{
            PreparedStatement pstm1 = con.getConnection().prepareStatement(SQL);
            pstm1.execute();
            JOptionPane.showMessageDialog(null,"Se borro el registro con exito...");
    ...
    public void NuevoMostrador(String cod, String num, String nom, String monto){
        ...
        try{
            ...
            pstm1.execute();
            JOptionPane.showMessageDialog(null,"Se agrego el Nuevo Empleado de Mostrador con exito");
        }
        catch(SQLException e){
            System.out.println(e);
            JOptionPane.showMessageDialog(null,"Error al agregar registro..");
    ...
    public ResultSet comboLocal(){
        ResultSet res = null;
        try{
            PreparedStatement pstm=con.getConnection().prepareStatement("SELECT l.Local_Nombre FROM lp l, producto p WHERE l.Producto_codigo = p.codigo");
            res=pstm.executeQuery();
        }
        catch(SQLException e){
            System.out.println(e);
