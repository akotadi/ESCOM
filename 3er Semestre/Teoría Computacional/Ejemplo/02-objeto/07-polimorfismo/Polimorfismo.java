...
int ladom ,ladoM ;
  ...
  // CONSTRUCTOR
  Elipse(int _x ,int _y ,int _ladoM ,int _ladom ,Color _color)
  {
      super(_x ,_y ,_color);
      ladom = _ladom;
      ladoM = _ladoM;
   ...
   {
       g.setColor(color);
       g.fillOval((int)(x - ladom) ,(int)(y - ladoM) ,ladom ,ladoM);
   }
}
