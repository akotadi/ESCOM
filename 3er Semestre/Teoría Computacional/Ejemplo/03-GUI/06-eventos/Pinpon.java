/* Pinpon.java
    ...
    JUEGO DE PINPON ENTRE EL TECLADO (AZUL) Y EL RATON (ROJO)
...
class Cancha extends JFrame implements Runnable
{
Thread hilo ;
  ...
  KeyListener eventoTeclado = new KeyListener() 
  {
    ...
    public void keyPressed(KeyEvent e) 
    {
        if( e.getKeyCode() == KeyEvent.VK_SPACE )
        {
          ...
          if( e.getKeyCode() == KeyEvent.VK_UP ) // TECLA HACIA ARRIBA
          {
          ...
          if( e.getKeyCode() == KeyEvent.VK_DOWN ) // TECLA HACIA ABAJO
          {
          Graphics g = getGraphics();
