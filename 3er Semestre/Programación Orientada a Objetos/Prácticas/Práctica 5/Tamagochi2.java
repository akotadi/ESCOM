...
public class Tamagochi extends JFrame  implements LeeRed {
  static String preguntas []= { "COMO TE LLAMAS","DONDE VIVES","CUANTOS AÑOS TIENES","DONDE ESTUDIAS","DONDE ESTAS","CUAL ES TU COLOR FAVORITO","DONDE NACISTE","PELICULA FAVORITA","COMO SE LLAMA TU MASCOTA","MUSICA FAVORITA"};
