...
public class Body{
    ...
    Frame frame1;
    Sphere cab;
    TransformGroup transformacion1;
    private TransformGroup objRotate=new TransformGroup(); 
    private TransformGroup objTras=new TransformGroup(); 
    Transform3D cabeza=new Transform3D();
    

    public TransformGroup getCab(){      
	return objRotate;
    }
    public Transform3D getCabeza(){
	return cabeza;
    }
    public Body(float x, float y, float z,String nombre_mostrar,boolean movimiento,Frame frame,String img){
	 ...
	 int primflags = Primitive.GENERATE_NORMALS
        + Primitive.GENERATE_TEXTURE_COORDS;
         ...
         objRotate = rotarY(cab);
         objTras = translate(objRotate, poscabeza);
         if(movimiento){
         ...
         MouseRotate rotator=new MouseRotate(/*transformacion1*/objRotate);
         rotator.setSchedulingBounds(bounds);
         MouseTranslate t=new MouseTranslate(/*transformacion1*/objRotate);
    ...
    TransformGroup rotarY(Node node) {
