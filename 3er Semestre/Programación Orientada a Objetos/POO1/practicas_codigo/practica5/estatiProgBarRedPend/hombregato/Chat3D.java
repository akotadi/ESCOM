...
void setup3DGraphics(){
   ...
   b1=new Body(-0.4f, 0.0f, 0.0f, "", true, this, "Avatar1");
   b1.changeTextureCab(texture, "carafeliz.jpg"); 
   BranchGroup group= b1.mybody();
   universe.addBranchGraph(group);
   b2=new Body(0.4f, 0.0f, 0.0f, "", true, this, "Avatar1");
   b2.changeTextureCab(texture, "carafeliz.jpg");  
   group= b2.mybody();
   //universe.addBranchGraph(group);
...
class EventHandler extends WindowAdapter implements ActionListener {  
  public void actionPerformed(ActionEvent e) {  
     ...
     if(btn==benfer){
       	b1.changeTextureCab(texture, "caraenfermo.jpg");
     }
  }
